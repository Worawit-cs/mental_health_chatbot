'''
This module is use for trans pdf to txt file
'''
import os
import pdfplumber
...
data_dir = os.path.expanduser("~/Documents/allProject/realProject/mental_health_chatbot/raw_data/markdown_data")
...
for filename in os.listdir(raw_data_dir):
    if filename.endswith(".pdf"):
        ...
        md_filename = os.path.splitext(filename)[0] + ".md"  # เปลี่ยนเป็น .md
